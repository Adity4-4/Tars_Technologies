  ...
  return (
    <>
      <div className='relative '>
        <img src={herosectionimage} className=' object-cover w-full h-[700px] lg:h-[742px]' />
        ...
        <div className='absolute inset-0 flex flex-col justify-center items-center text-center tracking-wider text-white pt-20 h-full  md:pt-38 lg:pt-42  z-10'>
          <p className='text-[26px] md:text-[35px] lg:text-[48px] text-transparent bg-clip-text bg-gradient-to-r from-white to-[#FFFFFF30] font-[neutral_face] mt-30 '>{heading}</p>
          ...
          <div className=' flex flex-col items-center gap-2 lg:gap-2 pt-30 md:pt-50 lg:pt-10  text-[13px] lg:text-[16px] font-[neutral_face]'>
            <p>SCROLL</p>
